...
#import "HomeModel.h"
@interface multipleCollectionCell()<UICollectionViewDelegate,UICollectionViewDataSource>
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    multipleCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:NSStringFromClass([multipleCell class]) forIndexPath:indexPath];
...
//
//    }];
    [cell configUIWithStr:[self.eDuQuestionItem.options safeObjectAtIndex:indexPath.row] selected:indexPath.row == [self.eDuQuestionItem.selected integerValue] && self.eDuQuestionItem.selected.length > 0  finishBlock:^{
...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.collectionView reloadData];
    if (self.multipleCollectionCellClickBlock) {
        self.multipleCollectionCellClickBlock(indexPath.row);
    }
...
-(UICollectionView *)collectionView{
    if (!_collectionView) {
        ...
        [_collectionView registerClass:[multipleCell class] forCellWithReuseIdentifier:NSStringFromClass([multipleCell class])];
