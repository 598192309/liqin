...
@protocol JPullEmailTFDelegate <NSObject>
- (void)JPullEmailTFTapCellDelegate:(NSInteger)row title:(NSString*)text;
@end


@interface JPullEmailTF : UITextField
@property (weak, nonatomic) id <JPullEmailTFDelegate> JPullEmailTFDelegate;
